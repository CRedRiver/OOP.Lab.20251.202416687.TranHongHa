...
import hust.soict.dsai.screen.controller.AddTrackScreenController;
...
public class AddTrack extends JFrame{
    ...
    public AddTrack(CompactDisc CD) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/dsai/screen/view/addTracks.fxml"));
