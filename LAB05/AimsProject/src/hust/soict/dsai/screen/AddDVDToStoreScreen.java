...
import hust.soict.dsai.screen.controller.AddDVDScreenController;
...
public class AddDVDToStoreScreen extends JFrame{
    ...
    public AddDVDToStoreScreen(Store store) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/dsai/screen/view/addDVD.fxml"));
